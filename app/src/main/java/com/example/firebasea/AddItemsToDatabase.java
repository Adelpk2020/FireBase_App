...
public class AddItemsToDatabase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_items_to_database);
        addToDBbtn=findViewById(R.id.btnAddNewFood);
        etNewFood=findViewById(R.id.add_new_food);
        ...
        addToDBbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!newFood.equals("")) {
                    ...
                    myRef.child("users").child(userId).child("Food").child("favorite food").child(newFood).setValue("true");
